...
interface Step5OutputsProps {
  formData: FormData;
  setFormData: (data: FormData) => void;
}

export const Step5Outputs: React.FC<Step5OutputsProps> = ({ formData, setFormData }) => {
    ...
    <div className="h-full flex flex-col max-w-2xl mx-auto w-full">
      ...
      <div className="space-y-4">
        ...
        <OutputOption 
          id="socialPost" 
          label="Social Post" 
          desc="Design with cover art (CD case, Record, etc.)."
          icon={Instagram}
          checked={formData.outputs.socialPost}
        />
      </div>
