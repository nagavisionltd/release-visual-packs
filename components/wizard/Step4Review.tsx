        ...
        <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10">
            ...
            <div className="p-6 space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {formData.outputs.socialClips && <span className="px-3 py-1 rounded-md bg-white/10 text-xs border border-white/10">Social Clips</span>}
                    {formData.outputs.lyricVideo && <span className="px-3 py-1 rounded-md bg-violet-500/20 text-violet-200 text-xs border border-violet-500/30">Lyric Video</span>}
                </div>
            </div>
        </div>
      </div>
